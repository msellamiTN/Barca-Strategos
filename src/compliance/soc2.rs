    ...
    async fn load_soc2_controls(&mut self) -> Result<(), ComplianceError> {
        ...
        let controls = vec![
            ...
            SOC2Control {
                ...
                category: SOC2ControlCategory::Technical,
                subcategories: vec![
                    "External penetration testing".to_string(),
                    "Internal penetration testing".to_string(),
                    "Red team testing".to_string(),
                    "Vulnerability validation".to_string(),
                    ],
                ],
                objective: "Identify and validate security controls".to_string(),
                control_type: SOC2ControlType::Technical,
                status: SOC2ControlStatus::NotImplemented,
                implementation_date: None,
                last_review_date: None,
